...
// ============ STYLES ============
const S = {
  container: { maxWidth: 1200, margin: '0 auto', padding: '24px', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif', background: 'linear-gradient(to bottom, #ecfdf5, #ffffff)', minHeight: '100vh', width: '100%', boxSizing: 'border-box' as const },
  ...
  card: { background: 'white', borderRadius: 16, padding: 28, boxShadow: '0 4px 20px rgba(0,0,0,0.06)', marginBottom: 20, border: '1px solid #d1fae5', width: '100%',  boxSizing: 'border-box' as const},
  ...
  kvV: { color: '#111827', fontSize: 14, textAlign: 'right' as const, fontWeight: 600, overflowWrap: 'break-word' as const, wordBreak: 'break-word' as const, maxWidth: '60%'},
  ...
  section: { marginTop: 16, padding: 20, background: '#ecfdf5', borderRadius: 12, border: '2px solid #a7f3d0', width: '100%', minWidth: 0, boxSizing: 'border-box' as const, overflowWrap: 'break-word' as const, wordBreak: 'break-word' as const },
  secTitle: { fontSize: 16, fontWeight: 700, color: '#047857', marginBottom: 14, display: 'flex', alignItems: 'center', gap: 8 },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))',  gap: 16},
  summary: { background: 'linear-gradient(135deg, #fef3c7 0%, #fef9c3 100%)', border: '2px solid #fbbf24', borderRadius: 12, padding: 16, fontSize: 14, color: '#78350f', lineHeight: 1.6, marginTop: 16, width: '100%', boxSizing: 'border-box' as const, overflowWrap: 'break-word' as const, wordBreak: 'break-word' as const },
